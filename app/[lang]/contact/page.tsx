...
const channelIcons = [
  ...
  (
    <svg key="address" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#7c3aed" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {dict.contactPage.channels.map((ch, i) => (
              ...
              >
                ...
                {channelLinks[i]?.link ? (
                  ...
                  <address className="not-italic text-brand-yellow font-bold text-sm whitespace-pre-line">
                    {ch.linkText}
                  </address>
                )}
              </div>
